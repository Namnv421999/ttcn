    ...
    <div style="padding:15px 5px 5px 5px">
        ...
        <div style="padding:15px 5px 5px 5px">
            <table style="width:640px;">
                <tr>
                    <td colspan="3" style="padding:0 0 10px 0;color:#44280E;"><h1 align="center" style="font-size: medium; background-color: #00FFFF; font-family: Arial; font-style: italic">Thông tin người mua hàng </h1></td>
                </tr>
                <tr>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                  ...
                  <tr>
                    <td class="label_thanhtoan">Ngày giao hàng :</td><td class="textbox_thanhtoan"><asp:TextBox ID="txtNgayGiao" runat="server" CssClass="textbox_thanhtoan" AutoPostBack="True" OnTextChanged="txtNgayGiao_TextChanged"></asp:TextBox> </td>
                    <td>
