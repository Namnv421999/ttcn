...
namespace ShopQuanAo
{
    public class DAO_SanPham : QuanLyKetNoi
    {
        ...
        public DataTable TimKiemSanPham(string TenSP)
        {
            ...
            dao.Open();
            string qry = "SELECT * FROM SANPHAM WHERE TENSP LIKE N'%" + TenSP + "%'";
        ...
        public void ThemSP(SanPham sp)
        {
            DAO_SanPham dao = new DAO_SanPham();
            dao.Open();
            string qry = "insert into SanPham(MaSP,TenSP,GiaMua,GiaBan,LoaiSP,ChuDe,ThongTin,GioiTinh,NgayNhapHang,HinhAnh) values("+sp.MaSP +",N'" + sp.TenSP + "'," + sp.GiaMua + "," + sp.GiaBan + "," + sp.LoaiSP + "," + sp.ChuDe + ",N'" + sp.ThongTin + "'," + sp.GioiTinh + ",N'" + sp.NgayNhap + "',N'" + sp.HinhAnh + "')";
