        ...
        <div style="padding:15px 5px 5px 5px">
            <table style="width:640px;">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                  ...
                  <tr>
                    <td class="label_thanhtoan">Ngày giao hàng :</td><td class="textbox_thanhtoan"><asp:TextBox ID="txtNgayGiao" runat="server" CssClass="textbox_thanhtoan">2021/2/2</asp:TextBox> </td>
                    <td>
